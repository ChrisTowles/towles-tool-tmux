...
/** A provider with full sidebar management (window + sidebar) capabilities. */
export type FullSidebarCapable = MuxProviderV1 & WindowCapable & SidebarCapable;

/** Check if a provider supports full sidebar management (window + sidebar) */
export function isFullSidebarCapable(p: MuxProvider): p is FullSidebarCapable {
